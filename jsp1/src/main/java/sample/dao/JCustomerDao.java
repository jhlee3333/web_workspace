...
public class JCustomerDao {
	...
	public JCustomerDao(String custom_id, String name, String email, int age, Date reg_date) {
		// TODO Auto-generated constructor stub
	}

	//1. 회원 로그인 - 간단히 회원아이디를 입력해서 존재하면 로그인 성공
	public JCustomerDao selectByID(String custom_id) throws SQLException {
...
//							rs.getString(5));
			...
			result = new JCustomerDao(custom_id, name, email, age, reg_date);
