...
public class JProductDao {
	//2. 상품 목록 보기
	public List<JProductDao> selectAll() throws SQLException {
		Connection connection = OracleUtility.getConnection();
		String sql = "select * from j_product";
		PreparedStatement ps = connection.prepareStatement(sql);
		List<JProductDao> results = new ArrayList<>();
	...
	public List<JProductDao> selectByPname(String pname) throws SQLException {
		...
		ResultSet rs = ps.executeQuery();
		List<JProductDao> result = new ArrayList<>();
