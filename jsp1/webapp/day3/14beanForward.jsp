...
<body>
<h3>요청 전달 받기</h3>
<p>13forward.jsp로부터 요청을 전달을 받은 페이지입니다.
*주의 : 실행은 13forward.jsp에서 합니다.</p>
<ul>
	<li>url은 무엇인가요? : http://localhost:8081/jsp_1/day3/13forward.jsp</li>
...
14beanForward.jsp에 요청과 함께 전달됩니다.
</p>
<!-- 자바빈을 생성하는 useBean
	scope="request"를 작성하지 않으면 pageScope에서 reqDto 빈을 찾습니다.
	pageScope에서는 reqDto 자바빈이 없으므로 null입니다.
-->
