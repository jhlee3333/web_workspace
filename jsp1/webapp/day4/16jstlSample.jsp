...
<!-- for 시작값은 1, 마지막 값은 10, 변수명은 var로 지정, step은 증가값, 기본값 1 -->
	<c:out value="${i*10}"/><br>
	<c:out value="${status.index}"/><br>
<!-- 몇번째 값인지를 나타내는 index 출력,
	 varStatus는 for 동작의 상태(시작값, 마지막값, step, 현재 순서)를 참조할 변수명 -->
</c:forEach>
...
<!-- fmt -->
   ...
   <fmt:parseDate value="2022-11-03 20:14" var="datetime1" pattern="yyyy-MM-dd HH:mm"/> 
    현재시간과 날짜 : ${datetime1 }<br>  <!-- 출력 결과 : Thu Nov 03 00:00:00 KST 2022 -->
